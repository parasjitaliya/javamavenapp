...
public class EasyPointsReferralAccrual01 {
	public String data="E:\\ProductionWorkFlow\\DemoAPIExcels\\EasyPointsReferralAccrualJSONdata.xls";
	public WebDriver driver;
	public Workbook wb;
	public Sheet s;
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("D:\\LpaasWorkspace\\DailyScriptDemo\\Extent Reports\\11.html");
	public ExtentTest logger =report.startTest("EasyPointsReferralAccrual");
  @Test
  public void f() {
  }
  @BeforeMethod
  public void beforeMethod() throws BiffException, IOException, JSONException {
	  ...
	  dropdown.selectByVisibleText("wsEasyPointsReferralAccrual");
	  Actions a=new Actions(driver);
	   ...
	   File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		  FileUtils.copyFile(src, new File("D:\\LpaasWorkspace\\DailyScriptDemo\\Screenshots\\11."+i+".png"));
		  ...
		  if(JSONtag.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("D:\\LpaasWorkspace\\DailyScriptDemo\\Screenshots\\11."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("D:\\LpaasWorkspace\\DailyScriptDemo\\Screenshots\\11."+i+".png")); 
		  }
