...
public class AssignTier {
	public String data="DemoAPIExcels/AssignTierJSONdata.xls";
	...
	File f;
	String JSONtag; 	
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/1.html");
  ...
  public void f() throws IOException, BiffException {
	      ...
	      s=wb.getSheet(0);
		  System.setProperty("webdriver.chrome.driver","D:\\Java\\selenium_driver\\chromedriver.exe");
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Demo/1."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		  System.out.println(JSONresponse);
		  
		  if(JSONresponse.contains("Success")){
				    System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/1."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/1."+i+".png")); 
		  } 
