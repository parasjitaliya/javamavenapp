...
public class EasyPointsAccrualEOSS01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/10.html");
  ...
  public void beforeMethod() throws BiffException, IOException, RowsExceededException, WriteException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demo/10."+i+".png"));
	 ...
	 if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/10."+i+".png")); 
	 }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/10."+i+".png")); 
	 }
