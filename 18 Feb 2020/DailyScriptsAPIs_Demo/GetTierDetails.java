...
public class GetTierDetails {
	...
	@Test
	 public void wsGetTierDetails() throws IOException, BiffException {
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Demo/38."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
			System.out.println(JSONresponse);
		  if(JSONresponse.contains("TierName")){
				    System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/38."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/38."+i+".png")); 
		  } 
