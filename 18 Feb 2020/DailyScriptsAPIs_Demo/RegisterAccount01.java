...
public class RegisterAccount01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/23.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Demo/23."+i+".png"));
		 ...
		 /* JSONObject jsonObj = new JSONObject(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/23."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/23."+i+".png")); 
		  }
