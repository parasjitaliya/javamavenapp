...
public class UpdateMemberProfile {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/42.html");
  ...
  public void UpdateMemberprofile() throws BiffException, IOException {
	  ...
	  driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Demo/42."+i+".png"));
	   String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
	   System.out.println(JSONresponse);

		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/42."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/42."+i+".png")); 
		  }
