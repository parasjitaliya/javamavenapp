...
public class UseGV01 {
	public String data="DemoAPIExcels/UseGVJSONdata.xls";
	...
	String JSONtag;
	String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/32.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Demo/32."+i+".png"));
	   ...
	   System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/32."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/32."+i+".png")); 
		  }
