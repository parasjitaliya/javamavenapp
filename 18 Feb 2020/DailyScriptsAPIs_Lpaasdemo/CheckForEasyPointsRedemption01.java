...
public class CheckForEasyPointsRedemption01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/3.html");
  ...
  public void beforeMethod() throws BiffException, IOException, Exception, WriteException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/3."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
		      ...
		      logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/3."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		      logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/3."+i+".png")); 
	  }
