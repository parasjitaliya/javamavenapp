...
public class GenerateReferralCode01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/14.html");
  ...
  public void beforeMethod() throws IOException, BiffException {
	   ...
	   driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/14."+i+".png"));
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/14."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/14."+i+".png")); 
		  }
