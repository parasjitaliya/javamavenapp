...
public class GetAvailableGVS01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/16.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/16."+i+".png"));
	  ...
	  System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/16."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/16."+i+".png")); 
		  }
