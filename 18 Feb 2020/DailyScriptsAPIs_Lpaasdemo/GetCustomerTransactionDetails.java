...
public class GetCustomerTransactionDetails {
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/41.html");
	...
	@Test
	 public void wsGetCustomerTransactionDetails() throws IOException, BiffException, JSONException {
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/41."+i+".png"));
		  ...
		  if(JSONresponse.contains("0")){
			    	...
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/41."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/41."+i+".png")); 
		  } 
