...
public class SaveSKUBillDetails {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/20.html");
  ...
  public void SaveSKUBillDetail() throws BiffException, IOException, ParserConfigurationException, SAXException, InterruptedException {
	   ...
	   a.sendKeys(Keys.INSERT,s.getCell(11,1).getContents()).build().perform();
	   a.sendKeys(Keys.INSERT,"</SKUOfferCode>").build().perform();
	   a.sendKeys(Keys.ENTER,"<CountryCode>").build().perform();
	   a.sendKeys(Keys.INSERT,s.getCell(12,1).getContents()).build().perform();
	   ...
	   FileUtils.copyFile(src1, new File("screenshots/Lpaasdemo/20."+i+".png"));
       ...
       System.out.println(XMLresponse);
		  ...
		  if(XMLresponse.contains("Success")){
			  ...
			  logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/20."+i+".png")); 
		  }else{
			  System.out.println("Fail");
			  logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/20."+i+".png")); 
		  }
