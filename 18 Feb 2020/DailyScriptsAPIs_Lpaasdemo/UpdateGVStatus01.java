...
public class UpdateGVStatus01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/30.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
      ...
      s=wb.getSheet(0);
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/30."+i+".png"));
	   ...
	   System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/30."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/30."+i+".png")); 
		  }
