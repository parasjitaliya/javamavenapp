...
public class UpdateMemberProfile {
	public String data="LpaasDemoExcels/UpdateMemberProfile.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/42.html");
  ...
  public void UpdateMemberprofile() throws BiffException, IOException 
  {
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/42."+i+".png"));
	   String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
	   System.out.println(JSONresponse);

		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/42."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/42."+i+".png")); 
		  }
