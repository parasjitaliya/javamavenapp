...
public class UseGV01 {
	...
	String JSONtag;
	String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/32.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/32."+i+".png"));
	   ...
	   System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/32."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/32."+i+".png")); 
		  }
