...
public class EasyPointRefund {
	public String data="DemoloyaltyAPIExcels/EasyPointRefund.xls";
	...
	File f;
	String JSONtag; 	
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/44.html");
  ...
  public void wsEasyPointRefund() throws IOException, BiffException {
	  ...
	  s=wb.getSheet(0);
	  System.setProperty("webdriver.chrome.driver","/home/harish/Harish/Jar files/Chrome Driver/chromedriver");
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/44."+i+".png"));
	  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		System.out.println(JSONresponse);
		
	  if(JSONresponse.contains("Success")){
			    System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/44."+i+".png")); 
	  }
	  else{
			    System.out.println("Fail");
		    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/44."+i+".png")); 
	  } 
