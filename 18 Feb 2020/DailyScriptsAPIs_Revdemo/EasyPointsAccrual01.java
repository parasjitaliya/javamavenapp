...
public class EasyPointsAccrual01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/9.html");
  ...
  public void beforeMethod() throws BiffException, IOException, RowsExceededException, WriteException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/9."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/9."+i+".png")); 
      }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/9."+i+".png")); 
	  }
