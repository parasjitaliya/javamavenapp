...
public class GenerateOTP {
	public String data="RevdemoAPIExcels/GenerateOTP.xls";
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("/home/harish/Eclipse/LpaasProductionWorkFlow/ExtentReports/37.html");
	...
	@Test
	 public void GeneratOTP() throws IOException, BiffException, JSONException {
		  ...
		  FileUtils.copyFile(src, new File("/home/harish/Eclipse/LpaasProductionWorkFlow/screenshots/Revdemo/37."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
			  ...
			  try {
	              ...
	              System.out.println(Requestid);
	                  File f1=new File("RevdemoAPIExcels/Reuse.xls");
		  ...
		  if(JSONresponse.contains("Success")){
			    	...
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("/home/harish/Eclipse/LpaasProductionWorkFlow/screenshots/Revdemo/37."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("/home/harish/Eclipse/LpaasProductionWorkFlow/screenshots/Revdemo/37."+i+".png")); 
		  } 
