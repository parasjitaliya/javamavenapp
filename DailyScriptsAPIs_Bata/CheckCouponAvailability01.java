...
public class CheckCouponAvailability01 {
	public String data="DemoAPIExcels/CheckCouponAvailabilityJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/CheckCouponAvailability01.html");
    ...
    public void beforeMethod() throws BiffException, IOException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demo/CheckCouponAvailability01."+i+".png"));
	 ...
	 if(JSONresponse.contains("Success")){
		      ...
		      logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/CheckCouponAvailability01."+i+".png")); 
	 }else{
			  System.out.println("Fail");
		      logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/CheckCouponAvailability01."+i+".png")); 
	 }
