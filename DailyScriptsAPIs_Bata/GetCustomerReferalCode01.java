...
public class GetCustomerReferalCode01 {
	public String data="DemoAPIExcels/GetCustomerReferalCodeJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/GetCustomerReferalCode01.html");
  ...
  public void beforeMethod() throws IOException, BiffException, JSONException {
	   ...
	   driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Demo/GetCustomerReferalCode01."+i+".png"));
		  ...
		  if(JSONtag.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/GetCustomerReferalCode01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/GetCustomerReferalCode01."+i+".png")); 
		  }
