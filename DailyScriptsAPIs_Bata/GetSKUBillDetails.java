...
public class GetSKUBillDetails {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/GetSkuBillDetails.html");
	public ExtentTest logger =report.startTest("GetSKUBillDetails");
  ...
  public void addlimit() throws IOException, BiffException {
	  ...
	  dropdown.selectByVisibleText("wsGetSkuBilldetails");
	  ...
	  s=wb.getSheet(0);
	   ...
	   File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		  FileUtils.copyFile(src, new File("screenshots/Demo/GetSkuBillDetails."+i+".png"));
		  ...
		  if(JSONtag.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/GetSkuBIllDetails."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/Getskubilldetails."+i+".png")); 
		  }
