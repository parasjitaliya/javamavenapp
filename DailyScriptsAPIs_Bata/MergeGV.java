...
public class MergeGV {
	public String data="DemoAPIExcels/MergeGVJSONdata.xls";
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/MergeGV.html");
	...
	@Test
	 public void MergeGv() throws IOException, BiffException {
		  ...
		  a.sendKeys(Keys.INSERT,"\"8688051737\"").build().perform();
		  a.sendKeys(Keys.INSERT,",").build().perform();
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Demo/MergeGV."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		  System.out.println(JSONresponse);
		  
		  if(JSONresponse.contains("Success")){
				    System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/MergeGV."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/MergeGV."+i+".png")); 
		  } 
