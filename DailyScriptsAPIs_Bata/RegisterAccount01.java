...
public class RegisterAccount01 {
	public String data="DemoAPIExcels/RegisterAccountJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/RegisterAccount01.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Demo/RegisterAccount01."+i+".png"));
		 ...
		 /* JSONObject jsonObj = new JSONObject(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/RegisterAccount01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/RegisterAccount01."+i+".png")); 
		  }
