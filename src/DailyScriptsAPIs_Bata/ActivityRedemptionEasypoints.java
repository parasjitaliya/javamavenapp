...
public class ActivityRedemptionEasypoints {
	//Need to change data path and URL
	
	//This change is in case of Activity Redemption Easy Points tag should accept 0 or empty.
