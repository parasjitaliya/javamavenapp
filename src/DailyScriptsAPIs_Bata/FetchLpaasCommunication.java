...
public class FetchLpaasCommunication {
	public String data="DemoAPIExcels\\FetchLpaasCommunicationJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("D:\\LpaasWorkspace\\DailyScriptBataProd\\Extent reports\\FetchLpaasCommunication.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  dropdown.selectByVisibleText("wsFetchLpaasCommunication");
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  //Reading data from FetchLpaas Excel
	  f=new File(data);
	  wb = Workbook.getWorkbook(f);
	  s=wb.getSheet(0);
	  a.sendKeys(Keys.ENTER,"\"RecordsPerPage\":").build().perform();
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  a.sendKeys(Keys.ENTER,"\"CommunicationType\":").build().perform();
	  a.sendKeys(Keys.INSERT,s.getCell(6,i).getContents()).build().perform();
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  a.sendKeys(Keys.ENTER,"\"BrandCode\":").build().perform();
	  a.sendKeys(Keys.INSERT,s.getCell(7,i).getContents()).build().perform();
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  a.sendKeys(Keys.ENTER,"}").build().perform();
	  driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
	  File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
	  FileUtils.copyFile(src, new File("D:\\LpaasWorkspace\\DailyScriptBataProd\\Screenshots\\FetchLpaasCommunication."+i+".png"));
	 ...
	 if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("D:\\LpaasWorkspace\\DailyScriptBataProd\\Screenshots\\FetchLpaasCommunication."+i+".png")); 
	 }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("D:\\LpaasWorkspace\\DailyScriptBataProd\\Screenshots\\FetchLpaasCommunication."+i+".png")); 
	 }
