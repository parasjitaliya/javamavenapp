...
public class GetOTPDetailsApi {
	public String data="DemoAPIExcels\\GetOTPDetailsJSONdata.xls";
	public WebDriver driver;
	public Workbook wb;
	public Sheet s;
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports\\GetOTPDetails\\GetOTPDetails.html");
	public ExtentTest logger =report.startTest("GetOTPDetails");
  ...
  public void f() throws Exception {
	  ...
	  dropdown.selectByVisibleText("wsGetOTPDetails");
	  ...
	  a.sendKeys(Keys.INSERT,"{").build().perform();
	   ...
	   a.sendKeys(Keys.INSERT,",").build().perform();
	   a.sendKeys(Keys.ENTER,"\"Type\":").build().perform();
	   ...
	   File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		  FileUtils.copyFile(src, new File("Screenshots\\GetOTPDetails."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		  System.out.println(JSONresponse);
		  JSONObject jsonObj = new JSONObject(JSONresponse);
		  String JSONtag = jsonObj.getString("GetOTPResponse");
		  System.out.println(JSONtag);
		  if(JSONtag.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("Screenshots\\GetOTPDetails."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("Screenshots\\GetOTPDetails."+i+".png")); 
		  }
