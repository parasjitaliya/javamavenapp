...
public class SaveChildrenDetails01 {
	public String data="DemoAPIExcels/SaveChildrenDetailsJSONdata.xls";
	public String MasterData="DemoAPIExcels/MasterData.xls";
	public WebDriver driver;
	public Workbook wb;
	public Sheet s;
	File f;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/SaveChildrenDetails01.html");
    ...
    public void beforeMethod() throws BiffException, IOException {
	  ...
	  driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
		 ...
		 FileUtils.copyFile(src, new File("screenshots/Demo/SaveChildrenDetails01."+i+".png"));
		 ...
		 System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/SaveChildrenDetails01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/SaveChildrenDetails01."+i+".png")); 
		  }
