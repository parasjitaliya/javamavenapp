...
public class UnBlockCoupon {
	...
	File f;
	String JSONtag; 	
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/UnBlockCoupon.html");
	...
	public void UnblockCoupon() throws BiffException, IOException {
			  ...
			  FileUtils.copyFile(src, new File("screenshots/Demo/UnBlockCoupon."+i+".png"));
			  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
			  System.out.println(JSONresponse);

			  if(JSONresponse.contains("Success")){
				  System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/UnBlockCoupon."+i+".png")); 
 
			  }else{
				  System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/UnBlockCoupon."+i+".png")); 
