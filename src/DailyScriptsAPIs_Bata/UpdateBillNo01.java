...
public class UpdateBillNo01 {
	public String data="DemoAPIExcels/UpdateBillNoJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demo/UpdateBillNo01.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	   ...
	   File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		  FileUtils.copyFile(src, new File("screenshots/Demo/UpdateBillNo01."+i+".png"));
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demo/UpdateBillNo01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demo/UpdateBillNo01."+i+".png")); 
		  }
