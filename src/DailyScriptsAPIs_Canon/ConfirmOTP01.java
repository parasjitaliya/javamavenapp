...
public class ConfirmOTP01 {
	public String data="LpaasDemoExcels/ConfirmOTPJSONdata.xls";
	...
	String otp;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/ConfirmOTP01.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/ConfirmOTP01."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/ConfirmOTP01."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/ConfirmOTP01."+i+".png")); 
	  }
