...
public class CustomerAvailablePoints01 {
	public String data="LpaasDemoExcels/CustomerAvailablePointsJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/CustomerAvailablePoints01.html");
	public ExtentTest logger =report.startTest("CustomerAvailablePoints");
  @Test
  public void CustomerAvailablePoints() throws IOException, BiffException {
	   f=new File(data);
	   ...
	   dropdown.selectByVisibleText("wsCustomerAvailablePoints");
	   ...
	   a.sendKeys(Keys.INSERT,",").build().perform();
	   //Reading data from CustomerAvailablePoints Excel
	   f=new File(data);
	   wb = Workbook.getWorkbook(f);
	   s=wb.getSheet(0);
	   ...
	   a.sendKeys(Keys.INSERT,",").build().perform();
	   a.sendKeys(Keys.ENTER,"\"BillAmount\":").build().perform();
	   ...
	   driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/CustomerAvailablePoints01."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		  System.out.println(JSONresponse);
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/CustomerAvailablePoints01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/CustomerAvailablePoints01."+i+".png")); 
		  }
