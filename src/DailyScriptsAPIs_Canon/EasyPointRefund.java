...
public class EasyPointRefund {
	public String data="LpaasDemoExcels/EasyPointRefund.xls";
	...
	File f;
	String JSONtag; 	
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/EasyPointRefund.html");
  ...
  public void wsEasyPointRefund() throws IOException, BiffException {
	  ...
	  a.sendKeys(Keys.INSERT,"\"12582\"").build().perform();
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  f=new File(data);
	  wb = Workbook.getWorkbook(f);
	  s=wb.getSheet(0);
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/EasyPointRefund."+i+".png"));
	  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		System.out.println(JSONresponse);
	  if(JSONresponse.contains("Success")){
			    System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/EasyPointRefund."+i+".png")); 
	  }
	  else{
			    System.out.println("Fail");
		    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/EasyPointRefund."+i+".png")); 
	  } 
