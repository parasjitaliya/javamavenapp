...
public class EasyPointsAccrual01 {
	public String data="LpaasDemoExcels/EasyPointsAccrualJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/EasyPointsAccrual01.html");
  ...
  public void beforeMethod() throws BiffException, IOException, RowsExceededException, WriteException {
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  //Reading data from EasyPointsAccrual Excel
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/EasyPointsAccrual01."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/EasyPointsAccrual01."+i+".png")); 
      }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/EasyPointsAccrual01."+i+".png")); 
	  }
