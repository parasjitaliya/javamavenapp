...
public class GetCustomerReferalCode01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/GetCustomerReferalCode01.html");
  ...
  public void wsGetReferralCode() throws IOException, BiffException, JSONException {
	  ...
	  s=wb.getSheet(0);
	   ...
	   File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/GetCustomerReferalCode01."+i+".png"));
		  ...
		  if(JSONtag.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/GetCustomerReferalCode01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/GetCustomerReferalCode01."+i+".png")); 
		  }
