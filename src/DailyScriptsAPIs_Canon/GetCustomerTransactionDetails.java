...
public class GetCustomerTransactionDetails {
	public String data="LpaasDemoExcels/GetCustomerTransactionDetails.xls";
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/GetCustomerTransactionDetails.html");
	...
	@Test
	 public void wsGetCustomerTransactionDetails() throws IOException, BiffException, JSONException {
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/GetCustomerTransactionDetails."+i+".png"));
		  ...
		  if(JSONresponse.contains("0")){
				    System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/GetCustomerTransactionDetails."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/GetCustomerTransactionDetails."+i+".png")); 
		  } 
