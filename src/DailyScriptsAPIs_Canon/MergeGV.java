...
public class MergeGV {
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/MergeGV.html");
	...
	@Test
	 public void MergeGv() throws IOException, BiffException {
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/MergeGV."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		  if(JSONresponse.contains("Success")){
				    System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/MergeGV."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/MergeGV."+i+".png")); 
		  } 
