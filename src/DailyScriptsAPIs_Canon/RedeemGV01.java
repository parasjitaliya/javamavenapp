...
public class RedeemGV01 {
	public String data="LpaasDemoExcels/RedeemGVJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/RedeemGV01.html");
  ...
  public void beforeMethod() throws IOException, BiffException, JSONException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/RedeemGV01."+i+".png"));
		 ...
		 /* String JSONtag = jsonObj.getString("ReturnMessage");
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/RedeemGV01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/RedeemGV01."+i+".png")); 
		  }
