...
public class RegisterAccount01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/RegisterAccount01.html");
  ...
  public void beforeMethod() throws BiffException, IOException 
  {
	  ...
	  a.sendKeys(Keys.INSERT,s.getCell(32,i).getContents()).build().perform();
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/RegisterAccount01."+i+".png"));
		 ...
		 /* JSONObject jsonObj = new JSONObject(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/RegisterAccount01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/RegisterAccount01."+i+".png")); 
		  }
