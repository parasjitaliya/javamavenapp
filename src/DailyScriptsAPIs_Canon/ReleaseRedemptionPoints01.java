...
public class ReleaseRedemptionPoints01 {
	public String data="LpaasDemoExcels/ReleaseRedemptionPointsJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/ReleaseRedemptionPoints01.html");
  ...
  public void beforeMethod() throws IOException, BiffException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/ReleaseRedemptionPoints01."+i+".png"));
	  ...
	  System.out.println(JSONresponse);	  
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/ReleaseRedemptionPoints01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/ReleaseRedemptionPoints01."+i+".png")); 
		  }
