...
public class SaveChildrenDetails01 {
	public String data="LpaasDemoExcels/SaveChildrenDetailsJSONdata.xls";
	public String MasterData="LpaasDemoExcels/MasterData.xls";
	public WebDriver driver;
	public Workbook wb;
	public Sheet s;
	File f;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/SaveChildrenDetails01.html");
	public ExtentTest logger =report.startTest("SaveChildrenDetails");
    @Test
    public void SaveChildrenDetails() throws BiffException, IOException {
	  f=new File(data);
	  ...
	  a.sendKeys(Keys.INSERT,"[").build().perform();
		 ...
		 FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/SaveChildrenDetails01."+i+".png"));
		 String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		 System.out.println(JSONresponse);
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/SaveChildrenDetails01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/SaveChildrenDetails01."+i+".png")); 
		  }
