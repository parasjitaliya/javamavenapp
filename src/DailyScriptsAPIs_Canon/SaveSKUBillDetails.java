...
public class SaveSKUBillDetails {
	public String data="LpaasDemoExcels/SaveSKUBillDetailsXMLdata.xls";
	public WebDriver driver;
	public Workbook wb;
	public Sheet s;
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/SaveSKUBillDetails.html");
  ...
  public void SaveSKUBillDetail() throws BiffException, IOException, ParserConfigurationException, SAXException, InterruptedException {
	   ...
	   FileUtils.copyFile(src1, new File("screenshots/Lpaasdemo/SaveSKUBillDetails."+i+".png"));
       ...
       System.out.println(XMLresponse);
		  ...
		  if(XMLresponse.contains("Success")){
			  ...
			  logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/SaveSKUBillDetails."+i+".png")); 
		  }else{
			  System.out.println("Fail");
			  logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/SaveSKUBillDetails."+i+".png")); 
		  }
