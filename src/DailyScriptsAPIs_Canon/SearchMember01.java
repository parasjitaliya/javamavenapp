...
public class SearchMember01 {
	public String data="LpaasDemoExcels/SearchMemberJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/SearchMember01.html");
  ...
  public void beforeMethod() throws BiffException, IOException, InterruptedException {
       ...
       FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/SearchMember01."+i+".png"));
	   String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/SearchMember01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/SearchMember01."+i+".png")); 
		  }
