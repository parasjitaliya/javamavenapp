...
public class ValidateOTP {
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Lpaasdemo/ValidateOTP.html");
	...
	@Test
	 public void wsValidateOTP() throws IOException, BiffException {
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Lpaasdemo/ValidateOTP."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
			System.out.println(JSONresponse);
		  if(JSONresponse.contains("Success")){
				    System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Lpaasdemo/ValidateOTP."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Lpaasdemo/ValidateOTP."+i+".png")); 
		  } 
