...
public class CheckCouponAvailability01 {
	public String data="RevdemoAPIExcels/CheckCouponAvailabilityJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/CheckCouponAvailability01.html");
    ...
    public void beforeMethod() throws BiffException, IOException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Revdemo/CheckCouponAvailability01."+i+".png"));
	 ...
	 if(JSONresponse.contains("Success")){
		      ...
		      logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/CheckCouponAvailability01."+i+".png")); 
	 }else{
			  System.out.println("Fail");
		      logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/CheckCouponAvailability01."+i+".png")); 
	 }
