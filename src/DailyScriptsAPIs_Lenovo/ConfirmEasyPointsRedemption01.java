...
public class ConfirmEasyPointsRedemption01 {
	public String data="RevdemoAPIExcels/ConfirmEasyPointsRedemptionJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/ConfirmEasyPointsRedemption01.html");
  ...
  public void beforeMethod() throws IOException, BiffException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Revdemo/ConfirmEasyPointsRedemption01."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/ConfirmEasyPointsRedemption01."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/ConfirmEasyPointsRedemption01."+i+".png")); 
	  }
