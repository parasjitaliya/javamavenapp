...
public class ConfirmOTP01 {
	public String data="RevdemoAPIExcels/ConfirmOTPJSONdata.xls";
	...
	String otp;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/ConfirmOTP01.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Revdemo/ConfirmOTP01."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/ConfirmOTP01."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/ConfirmOTP01."+i+".png")); 
	  }
