...
public class EasyPointsAccrualEOSS01 {
	public String data="RevdemoAPIExcels/EasyPointsAccrualEOSSJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/EasyPointsAccrualEOSS01.html");
  ...
  public void beforeMethod() throws BiffException, IOException, RowsExceededException, WriteException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Revdemo/EasyPointsAccrualEOSS01."+i+".png"));
	 ...
	 if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/EasyPointsAccrualEOSS01."+i+".png")); 
	 }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/EasyPointsAccrualEOSS01."+i+".png")); 
	 }
