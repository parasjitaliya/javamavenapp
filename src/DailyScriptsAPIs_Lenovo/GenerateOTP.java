...
public class GenerateOTP {
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("chromedriver");
	...
	@Test
	 public void GeneratOTP() throws IOException, BiffException, JSONException {
		  ...
		  FileUtils.copyFile(src, new File("/home/harish/Eclipse/LpaasProductionWorkFlow/screenshots/Revdemo/GenerateOTP."+i+".png"));
		  ...
		  if(JSONresponse.contains("Success")){
			    	...
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("/home/harish/Eclipse/LpaasProductionWorkFlow/screenshots/Revdemo/GenerateOTP."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("/home/harish/Eclipse/LpaasProductionWorkFlow/screenshots/Revdemo/GenerateOTP."+i+".png")); 
		  } 
