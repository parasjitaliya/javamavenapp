...
public class RedeemCoupon01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/RedeemCoupon01.html");
  ...
  public void beforeMethod() throws BiffException, IOException, JSONException {
	  f=new File(data);
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Revdemo/RedeemCoupon01."+i+".png"));
	   ...
	   JSONObject jsonObj = new JSONObject(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/RedeemCoupon01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/RedeemCoupon01."+i+".png")); 
		  }
