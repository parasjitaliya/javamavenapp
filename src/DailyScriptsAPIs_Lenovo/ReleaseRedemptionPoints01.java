...
public class ReleaseRedemptionPoints01 {
	public String data="RevdemoAPIExcels/ReleaseRedemptionPointsJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/ReleaseRedemptionPoints01.html");
  ...
  public void beforeMethod() throws IOException, BiffException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Revdemo/ReleaseRedemptionPoints01."+i+".png"));
	  ...
	  System.out.println(JSONresponse);	  
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/ReleaseRedemptionPoints01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/ReleaseRedemptionPoints01."+i+".png")); 
		  }
