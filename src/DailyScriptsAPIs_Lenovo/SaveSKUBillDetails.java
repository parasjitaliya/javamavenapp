...
public class SaveSKUBillDetails {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/SaveSKUBillDetails.html");
  ...
  public void SaveSKUBillDetail() throws BiffException, IOException, ParserConfigurationException, SAXException, InterruptedException {
	   ...
	   FileUtils.copyFile(src1, new File("screenshots/Revdemo/SaveSKUBillDetails."+i+".png"));
       ...
       System.out.println(XMLresponse);
		  ...
		  if(XMLresponse.contains("Success")){
			  ...
			  logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/SaveSKUBillDetails."+i+".png")); 
		  }else{
			  System.out.println("Fail");
			  logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/SaveSKUBillDetails."+i+".png")); 
		  }
