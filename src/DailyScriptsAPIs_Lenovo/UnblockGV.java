...
public class UnblockGV {
	...
	File f;
	String JSONtag; 	
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/UnblockGV.html");
	...
	public void UnblockCoupon() throws BiffException, IOException {
		  ...
		  s=wb.getSheet(0);
			  ...
			  FileUtils.copyFile(src, new File("screenshots/Revdemo/UnblockGV."+i+".png"));
			  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
			  System.out.println(JSONresponse);

			  if(JSONresponse.contains("Success")){
				  System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/UnblockGV."+i+".png")); 
			  }else{
				  System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/UnblockGV."+i+".png")); 
			  }
