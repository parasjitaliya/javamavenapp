...
public class UseGV01 {
	public String data="RevdemoAPIExcels/UseGVJSONdata.xls";
	...
	String JSONtag;
	String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Revdemo/UseGV01.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  driver.findElement(By.xpath("//*[@id='btnSubmit']")).click();
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Revdemo/UseGV01."+i+".png"));
	   ...
	   System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Revdemo/UseGV01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Revdemo/UseGV01."+i+".png")); 
		  }
