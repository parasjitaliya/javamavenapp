...
public class CheckCouponAvailability01 {
	public String data="DemoloyaltyAPIExcels/CheckCouponAvailabilityJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/CheckCouponAvailability01.html");
	public ExtentTest logger =report.startTest("CheckCouponAvailability");
    ...
    public void beforeMethod() throws BiffException, IOException {
	  ...
	  dropdown.selectByVisibleText("wsCheckCouponAvailability");
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  //Reading data from CheckCouponAvailability Excel
	  f=new File(data);
      wb = Workbook.getWorkbook(f);
      s=wb.getSheet(0);
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/CheckCouponAvailability01."+i+".png"));
	 ...
	 if(JSONresponse.contains("Success")){
		      ...
		      logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/CheckCouponAvailability01."+i+".png")); 
	 }else{
			  System.out.println("Fail");
		      logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/CheckCouponAvailability01."+i+".png")); 
	 }
