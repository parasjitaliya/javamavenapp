...
public class CheckForEasyPointsRedemption02 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/CheckForEasyPointsRedemption02.html");
  ...
  public void beforeMethod() throws BiffException, IOException, Exception, WriteException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/CheckForEasyPointsRedemption02."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
		      ...
		      logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/CheckForEasyPointsRedemption02."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		      logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/CheckForEasyPointsRedemption02."+i+".png")); 
	  }
