...
public class ConfirmEasyPointsRedemption01 {
	public String data="DemoloyaltyAPIExcels/ConfirmEasyPointsRedemptionJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/ConfirmEasyPointsRedemption01.html");
  ...
  public void beforeMethod() throws IOException, BiffException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/ConfirmEasyPointsRedemption01."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/ConfirmEasyPointsRedemption01."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/ConfirmEasyPointsRedemption01."+i+".png")); 
	  }
