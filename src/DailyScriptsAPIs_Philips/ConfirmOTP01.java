...
public class ConfirmOTP01 {
	public String data="DemoloyaltyAPIExcels/ConfirmOTPJSONdata.xls";
	...
	String otp;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/ConfirmOTP01.html");
	public ExtentTest logger =report.startTest("ConfirmOTP");
  ...
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  dropdown.selectByVisibleText("wsConfirmOTP");
	  ...
	  a.sendKeys(Keys.INSERT,"\"" +s.getCell(0,i).getContents()+"\"").build().perform();
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  //Takes data from ConfirmOTP file
	  f=new File(data);
	  wb = Workbook.getWorkbook(f);
	  s=wb.getSheet(0); 
	  try {
	  ...
	  a.sendKeys(Keys.ENTER,"\"SmsCode\":").build().perform();
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/ConfirmOTP01."+i+".png"));
	  ...
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/ConfirmOTP01."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/ConfirmOTP01."+i+".png")); 
	  }
