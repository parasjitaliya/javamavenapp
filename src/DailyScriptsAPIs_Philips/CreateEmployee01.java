...
public class CreateEmployee01 {
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/CreateEmployee01.html");
  ...
  public void beforeMethod() throws BiffException, IOException, JSONException {
	  ...
	  a.sendKeys(Keys.INSERT,"{").build().perform();
	   ...
	   File src=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/CreateEmployee01."+i+".png"));
		  ...
		  if(JSONtag.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/CreateEmployee01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/CreateEmployee01."+i+".png")); 
		  }
