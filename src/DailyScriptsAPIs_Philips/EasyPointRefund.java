...
public class EasyPointRefund {
	...
	File f;
	String JSONtag; 	
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/EasyPointRefund.html");
  ...
  public void wsEasyPointRefund() throws IOException, BiffException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/EasyPointRefund."+i+".png"));
	  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
		System.out.println(JSONresponse);
		
	  if(JSONresponse.contains("Success")){
			    System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/EasyPointRefund."+i+".png")); 
	  }
	  else{
			    System.out.println("Fail");
		    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/EasyPointRefund."+i+".png")); 
	  } 
