...
public class FlatEasyPointsAccrual01 {
	public String data="DemoloyaltyAPIExcels/FlatEasyPointsAccrualJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/FlatEasyPointsAccrual01.html");
	public ExtentTest logger =report.startTest("FlatEasyPointsAccrual");
  ...
  public void beforeMethod() throws IOException, BiffException {
	  ...
	  dropdown.selectByVisibleText("wsFlatEasyPointsAccrual");
	  ...
	  //Reading data from FlatEsayPointsAccrual Excel
	  f=new File(data);
	  wb = Workbook.getWorkbook(f);
	  s=wb.getSheet(0); 
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  a.sendKeys(Keys.ENTER,"\"LapseEndDate\":").build().perform();
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/FlatEasyPointsAccrual01."+i+".png"));
	  ...
	  System.out.println(JSONresponse);
		  ...
		  System.out.printlnimport org.json.JSONObject;
          (JSONtag);*/
	  
	  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/FlatEasyPointsAccrual01."+i+".png")); 
	  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/FlatEasyPointsAccrual01."+i+".png")); 
	  }
