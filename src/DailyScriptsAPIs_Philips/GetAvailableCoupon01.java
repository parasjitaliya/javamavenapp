...
public class GetAvailableCoupon01 {
	public String data="DemoloyaltyAPIExcels/GetAvailableCouponJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/GetAvailableCoupon01.html");
	public ExtentTest logger =report.startTest("GetAvailableCoupon");
  @Test
  public void f() {
  }
  @BeforeMethod
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  dropdown.selectByVisibleText("wsGetAvailableCoupon");
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  //Reading data from GetAvailableCoupon Excel
	  f=new File(data);
	  wb = Workbook.getWorkbook(f);
	  s=wb.getSheet(0);
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  a.sendKeys(Keys.ENTER,"\"DayInterval\":").build().perform();
	  a.sendKeys(Keys.INSERT,s.getCell(2,i).getContents()).build().perform();
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  a.sendKeys(Keys.ENTER,"\"CouponStatus\":").build().perform();
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/GetAvailableCoupon01."+i+".png"));
	  ...
	  System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/GetAvailableCoupon01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/GetAvailableCoupon01."+i+".png")); 
		  }
