...
public class GetAvailableGVS01 {
	public String data="DemoloyaltyAPIExcels/GetAvailableGVSJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/GetAvailableGVS01.html");
	public ExtentTest logger =report.startTest("GetAvailableGVS");
  @Test
  public void f() {
  }
  @BeforeMethod
  public void beforeMethod() throws BiffException, IOException {
	  ...
	  dropdown.selectByVisibleText("wsGetAvailableGVS");
	  ...
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  //Reading data from GetAvailableGVS Excel
	  f=new File(data);
	  wb = Workbook.getWorkbook(f);
	  s=wb.getSheet(0);	
	  a.sendKeys(Keys.ENTER,"\"GVStatus\":").build().perform();
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/GetAvailableGVS01."+i+".png"));
	     ...
	     /*JSONObject jsonObj = new JSONObject(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/GetAvailableGVS01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/GetAvailableGVS01."+i+".png")); 
		  }
