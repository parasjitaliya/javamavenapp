...
public class GetCustomerTransactionDetails {
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/GetCustomerTransactionDetails.html");
	...
	@Test
	 public void wsGetCustomerTransactionDetails() throws IOException, BiffException, JSONException {
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/GetCustomerTransactionDetails."+i+".png"));
		  ...
		  if(JSONresponse.contains("Member ID does not exists.")){
		    	...
		    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/GetCustomerTransactionDetails."+i+".png")); 
	       }  else  {
		   ...
		   JSONArray arr = jsonObj.getJSONArray("MemberTransactionResponseListDTO");
 		   for(int i1 = 0; i1 < arr.length(); i1++) {
 			  ...
 			  System.out.println(retnmsg);
			     ...
			     logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/GetCustomerTransactionDetails."+i+".png")); 
 		   }
	       }
