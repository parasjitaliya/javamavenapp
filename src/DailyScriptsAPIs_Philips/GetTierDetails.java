...
public class GetTierDetails {
	public String data="DemoloyaltyAPIExcels/GetTierdetails.xls";
	...
	String JSONtag; 
	public String otp;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/GetTierDetails.html");
	...
	@Test
	 public void wsGetTierDetails() throws IOException, BiffException {
		  ...
		  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/GetTierDetails."+i+".png"));
		  String JSONresponse=driver.findElement(By.xpath("//*[@id='txtResponse']")).getText();
			System.out.println(JSONresponse);
		  if(JSONresponse.contains("TierName")){
				    System.out.println("Pass");
			    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/GetTierDetails."+i+".png")); 
		  }
		  else{
				    System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/GetTierDetails."+i+".png")); 
		  } 
