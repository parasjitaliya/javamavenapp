...
public class IssueGV01 {
	public String data="DemoloyaltyAPIExcels/IssueGVJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/IssueGV01.html");
  ...
  public void beforeMethod() throws BiffException, IOException, JSONException {
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/IssueGV01."+i+".png"));
	  ...
	  System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/IssueGV01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/IssueGV01."+i+".png")); 
		  }
