...
public class ReleaseRedemptionPoints01 {
	public String data="DemoloyaltyAPIExcels/ReleaseRedemptionPointsJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/ReleaseRedemptionPoints01.html");
	public ExtentTest logger =report.startTest("ReleaseRedemptionPoints");
  ...
  public void beforeMethod() throws IOException, BiffException {
	  ...
	  dropdown.selectByVisibleText("wsReleaseRedemptionPoints");
	  ...
	  a.sendKeys(Keys.INSERT,"\"" +s.getCell(0,i).getContents()+"\"").build().perform();
	  //Takes data from ReleaseRedemptionPoints file
	  f=new File(data);
	  wb = Workbook.getWorkbook(f);
      s=wb.getSheet(0); 	
	  a.sendKeys(Keys.INSERT,",").build().perform();
	  ...
	  FileUtils.copyFile(src, new File("screenshots/Demoloyalty/ReleaseRedemptionPoints01."+i+".png"));
	  ...
	  System.out.println(JSONresponse);	  
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/ReleaseRedemptionPoints01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/ReleaseRedemptionPoints01."+i+".png")); 
		  }
