...
public class SaveSKUBillDetails {
	public String data="DemoloyaltyAPIExcels/SaveSKUBillDetailsXMLdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/SaveSKUBillDetails.html");
  ...
  public void SaveSKUBillDetail() throws BiffException, IOException, ParserConfigurationException, SAXException, InterruptedException {
	   ...
	   FileUtils.copyFile(src1, new File("screenshots/Demoloyalty/SaveSKUBillDetails."+i+".png"));
       ...
       System.out.println(XMLresponse);
		  ...
		  if(XMLresponse.contains("Success")){
			  ...
			  logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/SaveSKUBillDetails."+i+".png")); 
		  }else{
			  System.out.println("Fail");
			  logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/SaveSKUBillDetails."+i+".png")); 
		  }
