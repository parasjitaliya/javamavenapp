...
public class UnBlockCoupon {
	...
	File f;
	String JSONtag; 	
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/UnblockCoupon.html");
	...
	public void UnblockCoupon() throws BiffException, IOException {
			  ...
			  if(JSONresponse.contains("Success")){
				  ...
				  System.out.println("Fail");
			    	logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/34."+i+".png")); 
