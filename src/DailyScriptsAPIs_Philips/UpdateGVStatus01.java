...
public class UpdateGVStatus01 {
	public String data="DemoloyaltyAPIExcels/UpdateGVStatusJSONdata.xls";
	...
	File f;
	String JSONtag;
	public ExtentReports report=new ExtentReports("ExtentReports/Demoloyalty/UpdateGVStatus01.html");
  ...
  public void beforeMethod() throws BiffException, IOException {
      ...
      s=wb.getSheet(0);
	   ...
	   FileUtils.copyFile(src, new File("screenshots/Demoloyalty/UpdateGVStatus01."+i+".png"));
	   ...
	   System.out.println(JSONresponse);
		  ...
		  if(JSONresponse.contains("Success")){
			  System.out.println("Pass");
		    	logger.log(LogStatus.PASS,"Response is Success",logger.addScreenCapture("screenshots/Demoloyalty/UpdateGVStatus01."+i+".png")); 
		  }else{
			  System.out.println("Fail");
		    	 logger.log(LogStatus.FAIL ,"Failed",logger.addScreenCapture("screenshots/Demoloyalty/UpdateGVStatus01."+i+".png")); 
		  }
