...
public class UploadItemMasterCategory {
	//Upload Item Master Category
		public WebDriver driver;
		public String credentials="E:\\credentials.xls";
		public Workbook wb;
		public Sheet s;
		File f;
		public ExtentReports report=new ExtentReports("D:\\LpaasWorkspace\\Uploads\\Extent Reports\\UploadItemMasterCategory.html");
		public ExtentTest logger =report.startTest("Upload ItemMaster Category File");
  @Test
  public void UploadItemMasterCategor() throws InterruptedException, BiffException, IOException, AWTException {
  ...
  Thread.sleep(2000);
  uploadtype.selectByVisibleText("Category");
  Thread.sleep(3000);
  //Select Brand
  ...
  StringSelection ss = new StringSelection("D:\\SKU Uploads\\category upload2908.xlsx");
  ...
  WebElement Successmsg=driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_lblSuccess']"));
   if(Successmsg.isDisplayed() )
   {
	  ...
	  FileUtils.copyFile(src1, new File("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterCategory.png"));
    logger.log(LogStatus.PASS,"UploadItemMaster Category file is Successfully Uploaded",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterCategory.png"));
  }
  else{
	  System.out.println("fail");
	  logger.log(LogStatus.FAIL,"Failed",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterCategory.png"));
  }
