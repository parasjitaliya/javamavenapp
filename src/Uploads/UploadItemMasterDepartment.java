...
public class UploadItemMasterDepartment {
	//Upload Item Master Department
	public WebDriver driver;
	public String credentials="E:\\credentials.xls";
	public Workbook wb;
	public Sheet s;
	File f;
	public ExtentReports report=new ExtentReports("D:\\LpaasWorkspace\\Uploads\\Extent Reports\\UploadItemMasterDepartment.html");
	public ExtentTest logger =report.startTest("Upload Item Master Department File");
  @Test
  ...
  Thread.sleep(2000);
  uploadtype.selectByVisibleText("Department");
  Thread.sleep(3000);
  //Select Brand
  ...
  StringSelection ss = new StringSelection("D:\\SKU Uploads\\department upload2908.xlsx");
  ...
  WebElement Successmsg=driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_lblSuccess']"));
   if(Successmsg.isDisplayed() )
   {
	  ...
	  FileUtils.copyFile(src1, new File("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterDepartment.png"));
    logger.log(LogStatus.PASS,"UploadItemMaster Department file is Successfully Uploaded",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterDepartment.png"));
  }
  else{
	  System.out.println("fail");
	  logger.log(LogStatus.FAIL,"Failed",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterDepartment.png"));
  }
