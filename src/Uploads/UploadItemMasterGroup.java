...
public class UploadItemMasterGroup {
	//Upload ItemMaster Group
	...
	public Sheet s;
	File f;
	public ExtentReports report=new ExtentReports("D:\\LpaasWorkspace\\Uploads\\Extent Reports\\UploadItemMasterGroup.html");
	public ExtentTest logger =report.startTest("Upload ItemMaster Group");
  @Test
  public void UploadItemMasterGrou() throws InterruptedException, BiffException, IOException, AWTException {
  ...
  Thread.sleep(2000);
  uploadtype.selectByVisibleText("Group");
  Thread.sleep(3000);
  //Select Brand
  ...
  StringSelection ss = new StringSelection("D:\\SKU Uploads\\group upload2908.xlsx");
  ...
  WebElement Successmsg=driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_lblSuccess']"));
   if(Successmsg.isDisplayed() )
   {
	  ...
	  FileUtils.copyFile(src1, new File("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterGroup.png"));
    logger.log(LogStatus.PASS,"Upload ItemMaster Group file is Successfully Uploaded",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterGroup.png"));
  }
  else{
	  System.out.println("fail");
	  logger.log(LogStatus.FAIL,"Failed",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadItemMasterGroup.png"));
  }
