...
public class UploadMember {
	...
	public Sheet s;
	File f;
	public ExtentReports report=new ExtentReports("D:\\LpaasWorkspace\\Uploads\\Extent Reports\\UploadMember.html");
	public ExtentTest logger =report.startTest("Upload Member file");
  @Test
  public void UploadMembers() throws BiffException, IOException, InterruptedException, AWTException {
  ...
  driver.findElement(By.xpath("//*[text()='Upload Members']")).click();
  Thread.sleep(2000);
  //Upload Activities
  ...
  StringSelection ss = new StringSelection("D:\\Mirah Uploads\\Upload Member290821.xlsx");
  ...
  WebElement Successmsg=driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_lblSuccess']"));
   if(Successmsg.isDisplayed() )
   {
	  ...
	  FileUtils.copyFile(src1, new File("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadMember.png"));
    logger.log(LogStatus.PASS,"Upload Member File is Successfully Uploaded",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadMember.png"));
  }
  else{
	  System.out.println("fail");
	  logger.log(LogStatus.FAIL,"Failed",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadMember.png"));
  }
