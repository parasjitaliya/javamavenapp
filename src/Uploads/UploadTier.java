...
public class UploadTier {
	...
	public Sheet s;
	File f;
	public ExtentReports report=new ExtentReports("D:\\LpaasWorkspace\\Uploads\\Extent Reports\\UploadTier.html");
	public ExtentTest logger =report.startTest("Upload Tier file");
  @Test
  public void UploadTiers() throws BiffException, IOException, InterruptedException, AWTException {
  ...
  driver.findElement(By.xpath("//*[text()='Upload Tiers']")).click();
  Thread.sleep(2000);
  //Upload Activities
  ...
  StringSelection ss = new StringSelection("D:\\Mirah Uploads\\UploadTier290821.xlsx");
  ...
  WebElement Successmsg=driver.findElement(By.xpath("//*[@id='ctl00_ContentPlaceHolder1_lblSuccess']"));
   if(Successmsg.isDisplayed() )
   {
	  ...
	  FileUtils.copyFile(src1, new File("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadTier.png"));
    logger.log(LogStatus.PASS,"Upload Tier File is Successfully Uploaded",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadTier.png"));
  }
  else{
	  System.out.println("fail");
	  logger.log(LogStatus.FAIL,"Failed",logger.addScreenCapture("D:\\LpaasWorkspace\\Uploads\\Screenshots\\UploadTier.png"));
  }
